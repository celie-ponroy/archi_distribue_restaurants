...
class RestaurantServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SearchById = channel.unary_unary(
                ...
                request_serializer=restaurant__pb2.IdRequest.SerializeToString,
...
def add_RestaurantServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SearchById': grpc.unary_unary_rpc_method_handler(
                    servicer.SearchById,
                    request_deserializer=restaurant__pb2.IdRequest.FromString,
...
class RestaurantService(object):
    ...
    def SearchById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/restaurant.RestaurantService/SearchById',
            restaurant__pb2.IdRequest.SerializeToString,
